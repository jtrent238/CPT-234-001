...
void DisplayArray(double myAwesomeArray_UnSorted[], double myAwesomeArray[], double myAwesomeArray_Sorted[], const int ARRAY_AMOUNT);
void SortArray(double myAwesomeArray_UnSorted[], double myAwesomeArray[], double myAwesomeArray_Sorted[], const int ARRAY_AMOUNT);
void PrintArray(double myAwesomeArray_UnSorted[], double myAwesomeArray[], double myAwesomeArray_Sorted[], const int ARRAY_AMOUNT);
...
int main(void)
{
	...
	DisplayArray(myAwesomeArray_UnSorted, myAwesomeArray, myAwesomeArray_Sorted, ARRAY_AMOUNT);

	SortArray(myAwesomeArray_UnSorted, myAwesomeArray, myAwesomeArray_Sorted, ARRAY_AMOUNT);
	printf("\n"); // Blank Line

	// Print the sorted array
	printf("The sorted array:" "\n");
	PrintArray(myAwesomeArray_UnSorted, myAwesomeArray, myAwesomeArray_Sorted, ARRAY_AMOUNT);
...
// The number of passes will be 1 less than the number of elements
	for (int i = 0; i < ARRAY_AMOUNT - 1; i++)
	{
		...
		for (int j = 0; j < ARRAY_AMOUNT - (i + 1); j++)
		{
